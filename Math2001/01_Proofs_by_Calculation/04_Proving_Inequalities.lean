...
example {n : ℤ} (hn : n ≥ 10) : n ^ 4 - 2 * n ^ 2 > 3 * n ^ 3 :=
  calc
    ...
    -- The steps which should be automatically justified were: 0 ≤ n ^ 3
    _ ≥ 10 * n ^ 3 - 2 * n ^ 2 := by rel [hn]
    _ = 9 * n ^ 3 + n * n ^ 2 - 2 * n ^ 2 := by ring
    _ ≥ 9 * n ^ 3 + 10 * n ^ 2 - 2 * n ^ 2 := by rel [hn]
    _ = 9 * n ^ 3 + 8 * n ^ 2 := by ring
    _ ≥ 9 * n ^ 3 := by extra
